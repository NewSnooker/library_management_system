...
export default function LoadingFullScreen({ children }) {
  const loadingFull = useSelector((store) => store.loadingFull.loading);
  return (
    <>
      {loadingFull ? (
        <div className="relative w-full h-full overflow-hidden overscroll-none no-scrollbar">
          ...
          <div className="absolute no-scrollbar flex justify-center items-center inset-0 bg-zinc-900 z-50 opacity-85  h-full">
            ...
            <div role="status" className="pb-32 sm:pb-8">
              <svg
                aria-hidden="true"
                className="inline w-14 h-14 text-zinc-200 animate-spin dark:text-zinc-400 fill-zinc-800"
                viewBox="0 0 100 101"
                fill="none"
